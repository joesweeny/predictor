...
class FixtureServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.ListFixtures = channel.unary_stream(
        ...
        request_serializer=fixture__pb2.DateRangeRequest.SerializeToString,
    ...
    self.FixtureByID = channel.unary_unary(
        ...
        request_serializer=fixture__pb2.FixtureRequest.SerializeToString,
        response_deserializer=fixture__pb2.Fixture.FromString,
        )
...
def add_FixtureServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ListFixtures': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=fixture__pb2.DateRangeRequest.FromString,
      ...
      'FixtureByID': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=fixture__pb2.FixtureRequest.FromString,
          response_serializer=fixture__pb2.Fixture.SerializeToString,
      ),
  }
