...
from app.grpc.proto.fixture import fixture_pb2 as app_dot_grpc_dot_proto_dot_fixture_dot_fixture__pb2
...
def add_FixtureServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'ListFixtures': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=app_dot_grpc_dot_proto_dot_fixture_dot_fixture__pb2.DateRangeRequest.FromString,
          response_serializer=app_dot_grpc_dot_proto_dot_fixture_dot_fixture__pb2.Fixture.SerializeToString,
      ),
      'FixtureByID': grpc.unary_unary_rpc_method_handler(
          servicer.FixtureByID,
          request_deserializer=app_dot_grpc_dot_proto_dot_fixture_dot_fixture__pb2.FixtureRequest.FromString,
          response_serializer=app_dot_grpc_dot_proto_dot_fixture_dot_fixture__pb2.Fixture.SerializeToString,
      ),
  }
