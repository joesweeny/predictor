...
# source: app/grpc/proto/prediction/prediction.proto
...
Fixture = _reflection.GeneratedProtocolMessageType('Fixture', (_message.Message,), dict(
  DESCRIPTOR = _FIXTURE,
  __module__ = 'app.grpc.proto.prediction.prediction_pb2'
