...
# source: predictor/grpc/proto/stats/team/stats.proto
...
FixtureRequest = _reflection.GeneratedProtocolMessageType('FixtureRequest', (_message.Message,), dict(
  ...
  __module__ = 'predictor.grpc.proto.stats.team.stats_pb2'
