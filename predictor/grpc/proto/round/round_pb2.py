...
# source: predictor/grpc/proto/round/round.proto
...
Round = _reflection.GeneratedProtocolMessageType('Round', (_message.Message,), dict(
  DESCRIPTOR = _ROUND,
  __module__ = 'predictor.grpc.proto.round.round_pb2'
