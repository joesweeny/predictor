...
class OddsCompilerService(object):
    ...
    def GetEventMarket(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/proto.OddsCompilerService/GetEventMarket',
            compiler_dot_grpc_dot_proto_dot_compiler__pb2.EventRequest.SerializeToString,
            compiler_dot_grpc_dot_proto_dot_compiler__pb2.EventMarket.FromString,
