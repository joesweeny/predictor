...
# source: compiler/grpc/proto/round.proto
...
Round = _reflection.GeneratedProtocolMessageType('Round', (_message.Message,), {
  'DESCRIPTOR' : _ROUND,
  '__module__' : 'compiler.grpc.proto.round_pb2'
