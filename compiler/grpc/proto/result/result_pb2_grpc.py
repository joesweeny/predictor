...
class ResultServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.GetHistoricalResultsForFixture = channel.unary_stream(
        ...
        request_serializer=compiler_dot_grpc_dot_proto_dot_result_dot_result__pb2.HistoricalResultRequest.SerializeToString,
    ...
    self.GetResultsForTeam = channel.unary_stream(
        ...
        request_serializer=compiler_dot_grpc_dot_proto_dot_result_dot_result__pb2.TeamRequest.SerializeToString,
        response_deserializer=compiler_dot_grpc_dot_proto_dot_result_dot_result__pb2.Result.FromString,
        )
...
def add_ResultServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'GetHistoricalResultsForFixture': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=compiler_dot_grpc_dot_proto_dot_result_dot_result__pb2.HistoricalResultRequest.FromString,
      ...
      'GetResultsForTeam': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=compiler_dot_grpc_dot_proto_dot_result_dot_result__pb2.TeamRequest.FromString,
          response_serializer=compiler_dot_grpc_dot_proto_dot_result_dot_result__pb2.Result.SerializeToString,
      ),
  }
