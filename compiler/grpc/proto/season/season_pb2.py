...
# source: compiler/grpc/proto/season/season.proto
...
Season = _reflection.GeneratedProtocolMessageType('Season', (_message.Message,), dict(
  DESCRIPTOR = _SEASON,
  __module__ = 'compiler.grpc.proto.season.season_pb2'
